...
# Алгоритм:
# 1)Умножаем меньшее число на 10, пока оно не станет больше бо́льшего и увеличиваем k на 1
# 1)Делим бо́льшее на меньшее в столбик

# Выходные данные:
# Первая цифра деления и k

def DIV_NN_Dk(n_1, arr1, n_2, arr2):
    arr_1 = arr1.copy()    # не забудьте импортировать copy
    arr_2 = arr2.copy()
    k = 0
